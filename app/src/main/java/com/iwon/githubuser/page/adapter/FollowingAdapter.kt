...
class FollowingAdapter(private val mContext: Context, private val list: List<ListUsersResponse>) : RecyclerView.Adapter<FollowingAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_following, parent, false))
